...
## _(The goal of this section is to understand why keeping data and behavior together makes code easier to manage.)_
...
## (_The goal is to clearly understand how this works and when it changes._)
...
(_The purpose here is to understand how prototypes help share behavior efficiently._)
...
(_The goal is to understand how this can be manually controlled._)
